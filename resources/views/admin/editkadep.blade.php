                    ...
                    <form method="post"  action="/update_kadep/{{ $kdp->id }}" style="margin-right: 10px">
                        ...
                        <div class="form-group row mt-4">
                            <label for="colFormLabel" class="col-sm-2 col-form-label">Nama</label>
                                <div class="col-sm-8">
                                    <input type="text" name="nama" class="form-control" id="colFormLabel" value="{{ $kdp->nama_kadep }}" >
                                </div>
                        </div>
                                <div class="form-group row mt-4">
                                <label for="colFormLabel" class="col-sm-2 col-form-label">NIP</label>
                                <div class="col-sm-8">
                                <input type="text" onkeypress="return event.charCode >= 48 && event.charCode <=57" name="NIP" class="form-control" id="colFormLabel" value="{{ $kdp->NIP }}">
                                    </div>
                                    </div>
                                    <div class="form-group row mt-4">
                                        ...
                                        <div class="col-sm-8">
                                                    <select  class="form-select" name="prodi" aria-label="Default select example">
                                                        <option selected>{{ $kdp->prodi_kadep }}</option>
                                ...
                                <div class="col-sm-8">
                                <input type="email" name="email" class="form-control" id="colFormLabel" value="{{ $kdp->email_kadep }}" >
                                    </div>
                                    </div>
                                {{-- <div class="form-group row mt-4">
