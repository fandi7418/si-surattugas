...
<form style="margin-right: 10px" method="POST" action="/tambah_dosen">
    ...
    <div class="form-group row mt-4">
        ...
        <div class="col-sm-8">
            <input type="text" value="{{ old('pangkat') }}" name="pangkat"
                class="form-control @error('pangkat') is-invalid @enderror" id="colFormLabel"
                placeholder="Silahkan Masukkan Pangkat Anda">
            @error('pangkat')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
    ...
    <div class="form-group row mt-4">
        ...
        <div class="col-sm-8">
            <input type="text" value="{{ old('jabatan') }}" name="jabatan"
                class="form-control @error('jabatan') is-invalid @enderror" id="colFormLabel"
                placeholder="Silahkan Masukkan Jabatan Anda">
            @error('jabatan')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
