                    ...
                    <li>
                      <div class="scrollable-menu">
                        <table class="table" style="width: 500px">
                            <tbody id="isiNotif" style="width: 500px; margin-left: 5px; margin-right:5px">
                              <!-- isi notif -->
                            </tbody>
                          </table>
                        </div>
...
<main>
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: auto;">
      ...
      <ul class="nav nav-pills flex-column mb-auto">
        <li>
          <a href="/dashboardStaff" class="nav-link text-white">
        ...
        <li>
          <a href="/buatsuratStaff" class="nav-link text-white">
        ...
        <li>
          <a href="/daftarsuratStaff" class="nav-link text-white">
          ...
          $.ajax({
              ...
              success: function (data) {
                ...
                for (var i=0; i < data.surat.length; i++){
                  ...
                  $("#isiNotif").append(
                    `<tbody style="width: 500px; margin-left: 5px; margin-right:5px">
                        <tr>
